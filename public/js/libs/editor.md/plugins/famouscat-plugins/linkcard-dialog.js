(function(){
	...
	var pluginName   = "linkcard-dialog";
	exports.fn.linkcardDialog = function(){
	    var _this       = this;
	    var cm          = this.cm;
	    ...
	    cm.focus();
            if (editor.find("." + dialogName).length > 0){
                ...
                dialog.find("[data-title]").val("linkcard:"+selection);
                ...
                var dialogHTML = "<div class=\"" + classPrefix + "form\">" + 
                    ...
                    "<input type=\"text\" value=\"linkcard:" + selection + "\" data-title />" + 
                    "<br/>" +
                    "</div>";
